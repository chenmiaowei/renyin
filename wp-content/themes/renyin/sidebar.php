...
<div class="right">
    <div class="ho">
        <div class="neir"><a href="<?= get_permalink( get_page_by_path( 'register' ) ) ?>"><img
                        src="/wp-content/themes/renyin/resources/images/zc.jpg" width="180" height="39"
                        border="0"></a></div>
    </div>
    <!--Hosting Organizations-->
    <div class="ho">
        <div class="bt">下载专区</div>
        <div class="neir">
